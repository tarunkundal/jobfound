        ...
        <div className="w-full mx-auto">
            <div className="border-small bg-popover w-[80%] mx-auto rounded-card px-12 py-12">
                <div className="w-[80%] mx-auto text-center flex flex-col gap-4">
                    <h2 className="text-primary text-3xl md:text-4xl font-bold">Transform Your Job Search</h2>
                    <h2 className="text-secondary text-xl md:text-2xl">Powerful features designed to streamline your job application process</h2>
                </div>
                <div
                ...
                >
                    {infoData.map((feature, i) => (
                        <div
                            key={i}
                            className="bg-body text-secondary w-full lg:w-[45%] p-6 flex flex-col items-start gap-3 border-card shadow-card rounded-card"
                        >
